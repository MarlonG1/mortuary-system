<section>
    <div class="container-fluid py-3">
        <div class="row g-3">
            <div class="col-xl-3 col-md-6">
                <div class="card card-stats h-100">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <div class="card-header-icon glass-card">
                            <i class="fa-solid fa-file-invoice-dollar fa-xl"></i>
                        </div>
                        <div class="text-end">
                            <p class="card-category mb-0">Sales</p>
                            <h3 class="card-title">{{$totalSales}}</h3>
                        </div>
                    </div>
                    <div class="card-footer">
                        <div class="stats">
                            <a href="#">Watch <i class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
                <div class="card card-stats h-100">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-end">
                            <p class="card-category mb-0">Customers</p>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card card-stats h-100">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-end">
                            <p class="card-category mb-0">Products</p>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card card-stats h-100">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-end">
                            <p class="card-category mb-0">Profits</p>
            ...
            <div class="row col-12 col-md-11 pt-4 mx-auto">
                <div class=" p-4 mb-3 glass-dark-card glass-border rounded">
                    <div id="salesByMonth">
                    </div>
                </div>
            </div>
            <div class="row pb-3 mx-auto col-12 col-md-11">
                <div class="col-12 col-md-6 pb-4 pb-md-0 ps-md-0">
                    <div class="glass-dark-card glass-border rounded h-100 p-4 ">
                        <div id="salesByWeek">
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 pe-md-0">
                    <div
                        class="glass-dark-card glass-border rounded h-100 d-flex justify-content-center align-items-center">
            ...
            <div class="row col-12 col-md-11 mx-auto">
                ...
                <div class="col-12 col-sm-4 pb-md-0 pe-md-0 d-flex align-items-stretch">
                    <div class="col glass-dark-card glass-border rounded h-100">
                        <div class="table-responsive h-100 d-flex">
                            <table class="table glass-table mb-0" style="border-radius: 5px;">
                                <thead>
                                <tr>
                                    <th colspan="3" style="border-bottom: 1px solid rgba(136, 133, 133, 0.3);">Latest
                                        sales
                                    </th>
                                </tr>
                                <tr>
    ...
    <div class="tooltip" id="tooltip">
        <p class="m-0"><strong>Department: </strong><span id="tooltip-offices">Test</span></p>
        <p class="m-0"><strong>Employees: </strong><span id="tooltip-employees">Test</span></p>
        <p class="m-0"><strong>Total sales: </strong><span id="tooltip-totalSales">Test</span></p>
        <p class="m-0"><strong>Profits: </strong><span id="tooltip-profits">Test</span></p>
    </div>
</section>

@script
<script>
    const optionsMonthChart = {
        series: [{
            name: "Amount",
    ...
    const pieOptionsCharts = {
        series: @json($servicesAvailable),
        chart: {
            width: 370,
            type: 'pie',
        },
        ...
        labels: ['Available', 'Disable'],
        colors: ['#a2a2a2', '#575757'],
        stroke: {
            show: true,
            width: 0.5,
            colors: '#ffffff'
    ...
    const optionsWeekChart = {
        series: [{
            name: 'Amount   ',
            data: @json($salesByWeek)
        }],
        chart: {
            height: 300,
            type: 'bar',
    ...
    const pieChart = new ApexCharts(document.querySelector("#pieChart"), pieOptionsCharts);
    pieChart.render();

    const salesByWeekChart = new ApexCharts(document.querySelector("#salesByWeek"), optionsWeekChart);
    salesByWeekChart.render();

    const salesByMonthChart = new ApexCharts(document.querySelector("#salesByMonth"), optionsMonthChart);
    salesByMonthChart.render();

    let mapInformation = @json($mapInformation);

    console.log(mapInformation);

    const tooltip = document.getElementById('tooltip');
    const svgPaths = document.querySelectorAll('path[title]');

    svgPaths.forEach(path => {
        path.addEventListener('mouseover', function (event) {
                const locationIndex = mapInformation[0].indexOf(path.getAttribute('title'));
            if (locationIndex !== -1) {
                document.getElementById('tooltip-offices').innerText = mapInformation[0][locationIndex];
                document.getElementById('tooltip-employees').innerText = mapInformation[2][locationIndex];
                document.getElementById('tooltip-profits').innerText = '$' + mapInformation[3][locationIndex];
                document.getElementById('tooltip-totalSales').innerText = mapInformation[1][locationIndex];
            }
